...
public class TC08_ClassK_ValidationCheck_SubmitCase extends BaseTest
{
	...
	String Screenshotname="ClassK_ConfirmationScreen";  							//Screen shot name.
	...
	{	
		...
		// ut.select_self_onbehalf(i);
			...
			String AddScreenClassK=ut.captureScrenshot(Screenshotname);	
